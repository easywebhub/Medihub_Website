...
namespace RAT.Commons
{
    public class Globals
    {
        ...
        public static class StoreCodeConfig
        {
            ...
            public static readonly string RAT = "CS_0000337";
            public static readonly string Affiliate = "CS_0000275";
        }
        public static class BusinessConfig
        {
            public static readonly int RAT = 40;
            public static readonly string RATName = "RAT";
        }
        ...
        {
            public static string VTA = "Tại chi nhánh RAT";
